...
RcppExport SEXP _agroclimatico_C_pdsi(SEXP PSEXP, SEXP PESEXP, SEXP AWCSEXP, SEXP s_yrSEXP, SEXP e_yrSEXP, SEXP calib_s_yrSEXP, SEXP calib_e_yrSEXP, SEXP scSEXP, SEXP K1_1SEXP, SEXP K1_2SEXP, SEXP K1_3SEXP, SEXP K2SEXP, SEXP pSEXP, SEXP qSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_agroclimatico_C_pdsi", (DL_FUNC) &_agroclimatico_C_pdsi, 14},
    {NULL, NULL, 0}
};

RcppExport void R_init_agroclimatico(DllInfo *dll) {
