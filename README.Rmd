...
<!-- badges: start -->
[![R build status](https://github.com/AgRoMeteorologiaINTA/agroclimr/workflows/R-CMD-check/badge.svg)](https://github.com/AgRoMeteorologiaINTA/agroclimr/actions)
[![Codecov test coverage](https://codecov.io/gh/AgRoMeteorologiaINTA/agroclimr/branch/master/graph/badge.svg)](https://codecov.io/gh/AgRoMeteorologiaINTA/agroclimr?branch=master)
<!-- badges: end -->

El paquete {agroclimr} incluye una serie de funciones para calcular índices y estadísticos climáticos e hidrológicos a partir de datos tidy. Por ejemplo `umbrales()` permite contar la cantidad de observaciones que cumplen una determinada condición y `dias_promedios()` devuelve el primer y último día del año promedio de ocurrencia de un evento. 
...
Para contribuir con este paquete podés leer la siguiente [guía para contribuir](https://github.com/AgRoMeteorologiaINTA/agroclimr/blob/master/.github/CONTRIBUTING.md). Te pedimos también que revises nuestro [Código de Conducta](https://www.contributor-covenant.org/es/version/2/0/code_of_conduct/code_of_conduct.md). 
