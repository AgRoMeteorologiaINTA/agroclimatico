---
title: "Ejemplos de uso del paquete {agroclimatico}"
...
# remotes::install_github("AgRoMeteorologiaINTA/agroclimatico")
...
La función `spi_indice()` calcula el SPI para distintas escalas:

```{r}
datos %>% 
  summarise(spi_indice(fecha, prcp, 1:24)) %>% 
  head()
```
