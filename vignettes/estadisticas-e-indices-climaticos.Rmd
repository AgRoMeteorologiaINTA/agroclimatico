...
vignette: >
  %\VignetteIndexEntry{estadisticas-e-indices-climaticos}
...
```
La primera helada se da, en promedio, el 25 de junio y la úĺtima el 31 de julio.
